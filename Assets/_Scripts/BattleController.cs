...
public class BattleController : MonoBehaviour
{
    ...
    public void DecideAction(CharBase character) // etapa de decisão de ação do char, se for nulo chama o endturn pois todos já jogaram
    {
    ...
    public void EndTurn() // acaba o turno, limpa lista de ações tomadas
    {
        foreach (CharBase character in partyA.CharInParty)
        {
            if (character != null)
            {
                character.ClearActions(); // limpa a lista de ações do turno
            }
